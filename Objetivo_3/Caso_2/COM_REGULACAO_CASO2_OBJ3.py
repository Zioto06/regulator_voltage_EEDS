...
# ============================================================================
# 1. CONEXÃO COM O GOOGLE DRIVE E CONFIGURAÇÃO DA PASTA
# ============================================================================
try:
...
# ============================================================================
# ATENÇÃO: ALTERE APENAS ESTA VARIÁVEL COM O CAMINHO DA SUA PASTA
# ============================================================================
...
# --- 3.2 Extração de Neutro e Cálculo de Desequilíbrio (Nó P10) ---
...
if not df_mt.empty:
    plotar_perfil_estilo_relatorio(df_mt, "Média Tensão — Nós P1 a P5 (13,8 kV)", sub_mt)

# Gráfico 2: Baixa Tensão
if not df_bt.empty:
    plotar_perfil_estilo_relatorio(df_bt, "Baixa Tensão — Nós P6 a P10 (220/127 V e 240/120 V)", sub_bt, is_bt=True)
...
if not df_p10.empty:
    ...
    plotar_indicador(
        df=df_p10,
        coluna='V_Neutro',
        titulo='Deslocamento de Neutro (Seq. Zero) — Nó P10',
    ...
    plotar_indicador(
        df=df_p10,
        coluna='FD_perc',
        titulo='Fator de Desequilíbrio de Tensão (VUF) — Nó P10',
